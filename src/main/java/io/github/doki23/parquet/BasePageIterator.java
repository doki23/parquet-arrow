...
public abstract class BasePageIterator {
  ...
  protected void initRepetitionLevelsReader(DataPageV1 dataPageV1, ColumnDescriptor descriptor,
                                            ByteBufferInputStream in, int count) throws IOException {
  ...
  protected void initRepetitionLevelsReader(DataPageV2 dataPageV2, ColumnDescriptor descriptor) throws IOException {
    this.repetitionLevels = newRLEIterator(descriptor.getMaxRepetitionLevel(), dataPageV2.getRepetitionLevels());
  }

...
public class DecimalVectorUtil {
   ...
   */
  private static byte[] padBigEndianBytes(byte[] bigEndianBytes, int newLength) {
    ...
    throw new IllegalArgumentException(
        String.format("Buffer size of %d is larger than requested size of %d", bigEndianBytes.length, newLength));
  }
}
